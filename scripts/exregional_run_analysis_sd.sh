...
if [[ ${gsi_type} == "OBSERVER" || ${ob_type} == "conv" || ${ob_type} == "AERO" ]]; then
  ...
  #ln -sf /mnt/lfs1/BMC/wrfruc/hwang/rrfs_sd/pm/${YYYYMMDD}/pm25.airnow.${YYYYMMDD}${HH}.bufr pm25bufr
 ln -sf ${OBSPATH_PM}/${YYYYMMDD}/pm25.airnow.${YYYYMMDD}${HH}.bufr pm25bufr
fi
